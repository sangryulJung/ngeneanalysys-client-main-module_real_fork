 ...
 * @since 2017-09-08
 */
public class BrcaCancerInformationCore {
    private String bicCategory;
    private String bicImportance;
    private String bicClass;
     ...
     * @param bicClass
     */
    public void setBicClass(String bicClass) {
        this.bicClass = bicClass;
    }
